<template>
  <Grid :cols="2">
    ...
    <div
      ...
      class="overflow-y-scroll [-ms-overflow-style:none] scrollbar-none [&::-webkit-scrollbar]:hidden"
    >
      <Grid :cols="3">
        <div
        ...
        >
          ...
          <div
            v-else
            class="w-16 h-16 flex items-center justify-center bg-gray-100 dark:bg-gray-700 rounded text-2xl mb-2"
          >
            📄
          </div>
